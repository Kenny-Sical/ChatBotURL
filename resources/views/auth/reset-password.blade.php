...
<body class="d-flex align-items-center justify-content-center">
            ...
            <div class="col-12 col-sm-9 col-md-7 col-lg-5 col-xl-4">
                ...
                <div class="card auth-card">
                    ...
                    <div class="card-header py-4 text-white text-center">
                        ...
                        <p class="mb-0 mt-1 opacity-75 small">Elige una contraseña segura</p>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger border-0 rounded-3 py-2 px-3 mb-3"
                                 style="background-color:#fff0f0; border-left: 4px solid #dc3545 !important;">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-outline-secondary btn-toggle-pass"
                                            type="button" id="togglePass" tabindex="-1">
                    ...
                    <div class="card-footer bg-white text-center pb-4 rounded-bottom">
                        <a href="{{ route('login') }}" class="small link-accent">
    ...
    <!-- Reset Password -->
    <script src="{{ asset('js/auth/reset-password.js') }}?v={{ $version }}"></script>
